 ...
 * Rendered via a React portal at document.body to avoid stacking-context
 * issues with ancestor elements that use transforms or z-index.
 */
export function ProposalDrawer({ proposal, onClose }: ProposalDrawerProps) {
  ...
  return createPortal(
    <>
      {/* Backdrop — portalled to body so it always covers the full viewport */}
      <div
      ...
      <div className="fixed inset-0 z-[210] flex items-center justify-center p-6">
        ...
        >
          <ModalContent proposal={proposal} onClose={onClose} />
        </div>
      </div>
    </>,
    document.body,
