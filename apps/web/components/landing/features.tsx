...
function FeatureCard({
  ...
  return (
    <div
      ref={ref}
      className="rounded-xl border border-white/[0.06] bg-white/[0.02] overflow-hidden transition-all duration-700"
      style={{
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="flex flex-col justify-center p-6 sm:p-8">
          <h3 className="text-lg sm:text-xl font-semibold tracking-tight text-white text-balance">
            {title}
          </h3>
        ...
        <div className="border-t lg:border-t-0 lg:border-l border-white/[0.06] p-5 sm:p-6 flex items-center justify-center min-h-[240px]">
          {visual}
        </div>
      </div>
    </div>
      ...
      {[
        ...
        >
          <div className="flex-1 min-w-0">
            <p className={`text-xs font-medium ${approach.selected ? "text-emerald-300" : "text-white/60"}`}>
              {approach.label}
            </p>
          </div>
          <span
