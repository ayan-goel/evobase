    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="flex flex-col justify-center p-8">
          ...
          <p className="mt-3 text-sm sm:text-base leading-relaxed text-white/40">
            {description}
          </p>
        </div>
        <div className="border-t lg:border-t-0 lg:border-l border-white/[0.06] p-6 flex items-center justify-center min-h-[280px]">
          {visual}
        </div>
      </div>
    </div>
  ...
  return (
    <div className="w-full max-w-xs">
      <div className="rounded-lg border border-white/[0.08] bg-white/[0.03] overflow-hidden">
        ...
        <div className="p-4">
          <pre className="text-xs leading-relaxed text-white/40 whitespace-pre-wrap font-mono">
