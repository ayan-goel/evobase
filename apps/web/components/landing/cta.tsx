  ...
  return (
    <section className="px-6 py-20 sm:py-24">
      <div className="mx-auto max-w-3xl text-center">
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-10 sm:p-12 lg:p-14 relative overflow-hidden">
          {/* Subtle glow */}
          <div
          ...
          <h2 className="relative text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight text-white text-balance leading-[1.1]">
            Stop babysitting your codebase
          </h2>
          <p className="relative mt-4 text-base sm:text-lg text-white/40 max-w-md mx-auto leading-relaxed">
            Connect your repo, let evobase run continuously, and wake up to
            bulletproof PRs ready to merge.
          </p>
