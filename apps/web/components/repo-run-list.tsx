          ...
          {showPrButton && (
            runPrUrl ? (
              <a
                ...
                className="shrink-0 flex items-center gap-1.5 rounded-lg border border-emerald-500/25 bg-emerald-500/[0.08] px-3 py-1 text-xs font-medium text-emerald-300 hover:bg-emerald-500/15 transition-colors"
              >
              ...
              <button
                ...
                className="shrink-0 flex items-center gap-1.5 rounded-lg border border-white/15 bg-white/[0.05] px-3 py-1 text-xs font-medium text-white/60 hover:bg-white/[0.09] hover:text-white/80 transition-colors"
              >
                <GitHubIcon className="h-3.5 w-3.5 shrink-0" />
                Open PR
              </button>
