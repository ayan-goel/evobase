...
import type { Metrics, PatchVariant, ThinkingTrace } from "@/lib/types";
...
function PatchReasoningPanel({ trace }: { trace: ThinkingTrace }) {
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        <span className="text-xs text-white/30">{label} · {trace.model}</span>
        <span className="text-xs text-white/25" title={`${trace.prompt_tokens} prompt + ${trace.completion_tokens} completion`}>
